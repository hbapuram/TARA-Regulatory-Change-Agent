...
TARA is a prototype for a high-consequence regulatory domain. Contributions must be traceable, deterministic where consequential, and explicit about their evidence boundary.

## Before opening a pull request

1. Explain the user problem in plain language.
2. Identify every authoritative source used and the date it was checked.
3. Put domain rules in a domain pack rather than agent code whenever possible.
