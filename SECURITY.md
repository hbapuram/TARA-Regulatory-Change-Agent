...
TARA is a stateless regulatory-change prototype. The public demo is not designed to receive real personal, legal, tax, immigration, financial, or filing data.

## Report a vulnerability

Do not open a public issue containing exploit details, credentials, or personal data. Contact the repository owner privately through the security-reporting channel available on GitHub.
